...
export const ingredientOptions: Record<IngredientCategory, IngredientOption[]> = {
  ...
  bass: [
    ...
    option('beef-bass', 'bass', 'Bass / 主料', '大风吹人声', 'beef', 'bass-beef', { energy: 7, night: 5 }),
...
export const audioManifest = {
  ...
  tracks: [
    ...
    { id: 'bass-beef', category: 'bass', path: publicAsset('audio/loops/bass/beef-vocal.mp3') },
...
export const songs: Song[] = [
  ...
  },
  {
    ...
    coverFallback: '🌬️',
    promptTags: ['mandopop hook', 'vocal chop', 'windy groove', 'dramatic refrain'],
    analysis: { energy: 78, brightness: 68, chill: 42, night: 54 },
    originalIngredients: [
